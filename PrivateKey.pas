...
procedure CkPrivateKey_getUncommonOptions(objHandle: HCkPrivateKey; outPropVal: HCkString); stdcall;

procedure CkPrivateKey_putUncommonOptions(objHandle: HCkPrivateKey; newPropVal: PWideChar); stdcall;

function CkPrivateKey__uncommonOptions(objHandle: HCkPrivateKey): PWideChar; stdcall;
...
function CkPrivateKey_UploadToCloud(objHandle: HCkPrivateKey; jsonIn: HCkJsonObject; jsonOut: HCkJsonObject): wordbool; stdcall;

function CkPrivateKey_UploadToCloudAsync(objHandle: HCkPrivateKey; jsonIn: HCkJsonObject; jsonOut: HCkJsonObject): HCkTask; stdcall;
...
procedure CkPrivateKey_SetAbortCheck; external DLLName;
procedure CkPrivateKey_SetProgressInfo; external DLLName;
procedure CkPrivateKey_SetPercentDone; external DLLName;
procedure CkPrivateKey_SetTaskCompleted; external DLLName;
...
procedure CkPrivateKey_getUncommonOptions; external DLLName;
procedure CkPrivateKey_putUncommonOptions; external DLLName;
function CkPrivateKey__uncommonOptions; external DLLName;
...
function CkPrivateKey_UploadToCloud; external DLLName;
function CkPrivateKey_UploadToCloudAsync; external DLLName;
